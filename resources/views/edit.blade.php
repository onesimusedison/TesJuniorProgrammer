        ...
        <div class="container">
            <div class="mt-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('edit/produk/simpan', $produk->id_produk) }}">
                            @csrf
                            @method('put')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="kategori" aria-label="Default select example">
                                    ...
                                    <option value="{{ $ktgi->id_kategori }}" {{ old('kategori', $produk->kategori_id) == $ktgi->id_kategori ? 'selected' : '' }}>
                                        {{ $ktgi->nama_kategori }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="status" aria-label="Default select example">
                                    ...
                                    <option value="{{ $sts->id_status }}" {{ old('status', $produk->status_id) == $sts->id_status ? 'selected' : '' }}>
                                        {{ $sts->nama_status }}
                                    </option>
                                    @endforeach
                                </select>
